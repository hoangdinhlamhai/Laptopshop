                    ...
                    <div class="row">
                        <div class="col-md-6 col-12 mx-auto">
                            ...
                            <form:form method="post" action="/admin/product/create"
                                ...
                                <!-- col-12 để xem trên mobile được full màn
                                col-md-6: khi ở kích thước màn medium thì chiếm 6/12 cột -->
                                ...
                                <div class="mb-3 col-12 col-md-6">
                                    ...
                                    <form:input type="text"
                                                class="form-control ${not empty errorShorDesc ? 'is-invalid' : ''}"
                                                path="shortDesc"/>
                                        ${errorShorDesc}
                                </div>
                                <div class="mb-3 col-12 col-md-6">
