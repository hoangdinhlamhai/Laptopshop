...
<div class="container-fluid fruite mt-5">
    <div class="container py-5">
        <div class="row g-4 mb-5">
            ...
            <div class="row g-4">
                <%--ở màn medium div này chiếm 4/12 cột--%>
                <div class="col-12 col-md-4">
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-check form-check-inline">
                            <%--                            thêm checked để mới vào web thì tự động tíck vào ko sắp xếp--%>
                    ...
                    <div class="col-12">
                        <button
                        <%--thêm id để viết jQuery cho nhanh--%>
                ...
                <%--ở màn medium div này chiếm 8/12 cột--%>
